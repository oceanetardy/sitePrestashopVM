...
$context["action"], "type", [], "any", true, true) && ($this->getAttribute($context["action"], "type", []) == "button"))) {
    ...
    {
        return new Source("", "@PrestaShop/Admin/Helpers/bootstrap_popup.html.twig", "/var/www/html/sitePrestashop/src/PrestaShopBundle/Resources/views/Admin/Helpers/bootstrap_popup.html.twig");
    }
}
